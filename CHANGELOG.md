...
- **`RunSerial` state-sharing decided**: specs stay self-contained by design; the reasoning is recorded in [docs/planning/2026-08-30_runserial-state-sharing-design-note.md](docs/planning/2026-08-30_runserial-state-sharing-design-note.md) (07-45:f47).
