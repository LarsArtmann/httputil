...
// request body decompression with bomb protection, ETag conditional requests via
// the go-etag adapter, an HTTP server wrapper with graceful shutdown, standard health check handlers (/health, /health/live,
