...
1. **Push v0.6.1 + GitHub Release** (needs user approval)
2. **Decide v0.7.0 vs v1.0** (needs user decision)
3. **Write Release Runbook** (no gate, do while waiting)
4. **govulncheck local run** (no gate, do while waiting)
5. **Re-measure coverage** (no gate, do while waiting)

### Wave 2: High-value docs + security (~2h)

6. **6 config field tables in README**
7. **SECURITY.md**
8. **Annotate historical reports**
9. **Pre-1.0 versioning policy**

### Wave 3: API honesty (after direction decision, ~2h)

10. **v1.0 API renames**
11. **DenyUnmatched evaluation**
12. **v1.0 frozen API surface**

### Wave 4: Depth and confidence (~4h)

13. **Fuzz tests for newer surface**
14. **Close coverage gaps**
15. **Benchmarks (TokenBucketLimiter + full suite)**
16. **Example functions**
17. **WebSocket test variants**

### Wave 5: Extensibility proof (~3h)

18. **Brotli/zstd WriterFactory example**
19. **Redis RateLimiter example**
20. **Prometheus MetricsRecorder example**
