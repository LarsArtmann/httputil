...
> **Annotation (2026-08-07 docs-health):** All section A items (1–12) **done**. Section B items: D2 SVG **done** (regenerated by 06:50 session); honest-silence comments on remaining 6 sites **done** by 06:50 session; FEATURES timestamp **done**; AGENTS.md pattern **done**; LSP **restarted**. Section F items 1–6 **done** (immediate fixes). Items 7–12 (decompression coverage gaps) **done** — Close/Read now at 100%. Items 13–17 (ETag cross-middleware tests) — ETag was extracted to go-etag; these tests are now go-etag's responsibility. Items 18–22 (fuzz/benchmark hardening) — decompression fuzz/bench **done**; others are ETag-specific and moved to go-etag.
