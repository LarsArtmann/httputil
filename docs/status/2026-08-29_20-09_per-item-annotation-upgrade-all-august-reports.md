...
| 11  | **Caught and repaired my own table corruption** in `08-08_02-50` (see d.1); final `| |` scan across all 2026-08 reports: 0 hits; all 10 c-rows rebuilt cleanly with per-row hashes | Rows 48–62 verified line-by-line                                |
