...
1. ~~**Test environment is not self-documenting**\~~ done (AGENTS Commands documents the full cache-override + per-module commands)
...
2. ~~**Status report not committed**\~~ done (committed by the auto-commit daemon long ago)
